...
PEOPLE = [
    ...
    ("SEKPER", "Risk Champion", "MAN KOMUNIKASI DAN HUBUNGAN MASYARAKAT", "YOGA PERDANA SULASTAMA"),
    ("SEKPER", "Risk Officer", "ASMAN KESEKRETARIATAN DAN DOCUMENT CONTROL", "DINA SAFRINA"),
    ("SEKPER", "Risk Officer", "SOF PERUSAHAAN DAN REG PEMERINTAH", "SRI MURNIYANTI"),
