"""Finalizer KPMR SPI Juni 2026 / TW II V4.

Dry run:
  python monthly_report/scripts/finalize_spi_june_kpmr_2026_v4.py

Apply only after exact output 81/FAIR:
  python monthly_report/scripts/finalize_spi_june_kpmr_2026_v4.py --apply
"""
...
def main():
    ...
    report = MonthlyRiskReport.objects.select_related(
        "reassessment", "reassessment__unit_bisnis", "periode"
    ).get(pk=REPORT_ID)
    ...
    print("=" * 82)
    print("KPMR SPI - JUNI 2026 / SNAPSHOT TW II V4")
    print("=" * 82)
